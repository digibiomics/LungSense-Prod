...
MAX_XRAY_SIZE = 30 * 1024 * 1024  # 30 MB (covers DICOM)
MAX_AUDIO_SIZE = 50 * 1024 * 1024  # 50 MB

# Allowed file types
ALLOWED_XRAY_TYPES = {"jpg", "jpeg", "png", "dcm"}
...
def validate_xray_file(file: UploadFile) -> None:
    ...
    # Check content type — DICOM files often have empty/unknown MIME type in browsers
    allowed_content_types = {
        "image/jpeg", "image/jpg", "image/png",
        "application/dicom", "image/dicom", ""
    }
    if file_ext != "dcm" and file.content_type not in allowed_content_types:
