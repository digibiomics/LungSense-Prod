...
class User(Base):
    ...
    province = Column(String(10), nullable=True)  # ISO-3166-2 format
    ...
    institution_location_country = Column(String(2), nullable=True)
    institution_location_province = Column(String(10), nullable=True)
